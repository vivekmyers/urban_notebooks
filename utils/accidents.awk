...
NR > 1 {
    ...
    print "INSERT INTO Accidents VALUES(" "\""$1 " " arr[1] ":" arr[2]  ":00\"", $5, $6, $12, $13, $14, $15, $16, $17, $18, $19, "\""$26"\"", "\""$27"\"", "\""$28"\"", "\""$29"\"", "\""$30"\"" ");" | sql
