...
resources/stations.csv: | resources
	curl -L https://www.ncei.noaa.gov/orders/cdo/1440778.csv -o resources/weather.csv
...
resources/data.db: resources/uber.csv resources/accidents.csv resources/tolls.csv resources/jewish.csv resources/lines.csv resources/stations.csv resources/roads.geojson resources/311.csv resources/subway_locations.csv resources/taxis.csv resources/taxis2015.csv resources/turnstiles.csv
	$(foreach file,$^,awk -f utils/$(basename $(notdir $(file))).awk $(file);)
