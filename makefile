...
resources: 
	...
	for i in {1..6}; do curl -L https://s3.amazonaws.com/nyc-tlc/trip+data/yellow_tripdata_2015-0$i.csv; done > taxis2015.csv
	curl -L https://data.ny.gov/api/views/ekwu-khcy/rows.csv\?accessType\=DOWNLOAD -o turnstiles.csv
